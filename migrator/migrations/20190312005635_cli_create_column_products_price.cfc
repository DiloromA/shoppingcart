...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_products_price">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='products', columnType='integer', columnName='price' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
