...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_customers_name">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='customers', columnType='string', columnName='name' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='customers',columnName='name');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
