...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_carts_product_id">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='carts', columnType='integer', columnName='product_id' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='carts',columnName='product_id');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
