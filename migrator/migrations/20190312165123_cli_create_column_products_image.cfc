...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_products_image">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='products', columnType='string', columnName='image' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
