...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_products_quantity">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='products', columnType='integer', columnName='quantity' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='products',columnName='quantity');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
