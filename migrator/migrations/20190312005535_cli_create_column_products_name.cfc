...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_products_name">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='products', columnType='string', columnName='name' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='products',columnName='name');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
