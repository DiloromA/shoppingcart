...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_customers_password">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='customers', columnType='string', columnName='password' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='customers',columnName='password');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
