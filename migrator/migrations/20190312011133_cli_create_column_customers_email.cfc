...
--->
<cfcomponent extends="wheels.migrator.Migration" hint="CLI create_column_customers_email">
  <cffunction name="up">
  	<cfset hasError = false />
  	<cftransaction>
	    <cfscript>
	    	try{
	    		addColumn(table='customers', columnType='string', columnName='email' , null = true);
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
  ...
  <cffunction name="down">
  	...
  	<cftransaction>
	    <cfscript>
	    	try{
	    		removeColumn(table='customers',columnName='email');
	    	}
	    	catch (any ex){
	    		hasError = true;
		      	catchObject = ex;
